...
import com.dota.pearl18.activities.DeveloperDetails;
import com.dota.pearl18.activities.DeveloperLayoutDetails;
...
public class CreditsAdapter extends RecyclerView.Adapter<CreditsAdapter.CreditsViewHolder> {
    ...
    public CreditsViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(mContext).inflate(R.layout.item_credits, parent, false);
