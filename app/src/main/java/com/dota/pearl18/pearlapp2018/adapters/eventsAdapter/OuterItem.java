...
public class OuterItem extends HeaderItem {
    ...
    public OuterItem(View itemView, RecyclerView.RecycledViewPool pool) {
        ...
        mDesc = itemView.findViewById(R.id.htv_desc);
        mDesc2 = itemView.findViewById(R.id.htv_desc2);
        ...
        mMiddleCollapsible.add((View)mDesc.getParent());

        // Init RecyclerView
        mRecyclerView = (InnerRecyclerView) itemView.findViewById(R.id.inner_events);
    ...
    void setContent(@NonNull List<InnerData> innerDataList) {
        ...
        final String title1 = header.eventName;

        final Spannable title2 = new SpannableString(header.eventName + " - " + header.description);
        ...
        mDesc.setText(header.description);
        mDesc2.setText(header.description2);
    }
