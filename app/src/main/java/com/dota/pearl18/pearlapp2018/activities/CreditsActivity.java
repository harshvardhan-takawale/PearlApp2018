...
public class CreditsActivity extends AppCompatActivity {
    ...
    private ArrayList<DeveloperDetails> getDesigners(){
        ...
        details.add(new DeveloperDetails("Suraj Thotakura", R.drawable.profile_icon, new String[]{"https://www.facebook.com/satya.suraj.7", null, null, ""}));
        details.add(new DeveloperDetails("Govind Savio", R.drawable.profile_icon, new String[]{"", null, null, ""}));
